...
public interface AreaMapper extends BaseMapper<Area> {
	 ...
	 * @return
	 */
	public List<OptionVo> findDistrictOption(
	 ...
	 * @return
	 */
	public String getCodeById(@Param(value = "id") Integer id);
	 ...
	 * @return
	 */
	public Area findDistrictByDistrict(@Param(value = "district") String district);
	 ...
	 * @return
	 */
	public Area findAreaByCity(@Param(value = "city") String city);
