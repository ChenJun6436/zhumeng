...
public class PoiExcelExport {
	...
	/*
	 * public static void main(String[] args) { List<PoiBrandVo> list = new
	 * ArrayList<PoiBrandVo>(); PoiBrandVo pVo1 = new
	 * PoiBrandVo("111111-12345678", "1"); PoiBrandVo pVo2 = new
	 * PoiBrandVo("111111-12345678", "2"); PoiBrandVo pVo3 = new
	 * PoiBrandVo("111111-12345678", "3"); PoiBrandVo pVo4 = new
	 * PoiBrandVo("111111-12345678", "4"); list.add(pVo1); list.add(pVo2);
	 * list.add(pVo3); list.add(pVo4);
	 * 
	 * PoiExcelExport pee = new PoiExcelExport("D:/test.xls", "sheet1"); String
	 * titleColumn[] = { "sign" }; String titleName[] = { "标签" }; int
	 * titleSize[] = { 18 }; pee.wirteExcel(titleColumn, titleName, titleSize,
	 * list); }
	 */
}