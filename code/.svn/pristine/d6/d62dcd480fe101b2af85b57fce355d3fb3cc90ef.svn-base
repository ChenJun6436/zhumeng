...
public class ConstantsUtil {
    ...
    public static final String RES_LAWYER_FROZEN_ACCOUNT_MESSAGE = "该账户已被禁用，请联系我们";
     ...
     * 标签不存在
     */
    public static final String SIGN_NOT_EXIXT = "-1";

    /**
     * 标签未被激活
     */
    public static final String SIGN_NOT_ACTIVE = "-2";

    /**
     * 标签已经使用
     */
    public static final String SIGN_TO_USE = "-3";
	 ...
	 * 标签已经被激活
	 */
	public static final String SIGN_ACTIVE_STRING = "-4";
}
