// code by chenjun
'use strict'
const baseURL_OLD = 'http://zmtht.zhumatou.cn/'
const baseURL = 'http://192.168.5.154:8085/zmt_dp/'
const baseURL_a = 'http://192.168.5.154:8085/zmt/'
...
export const post_OLD = function (url, data) {
  return axios({
      method: 'post',
      baseURL: baseURL_OLD,
      url,
...
export const post_OLD_a = function (url, data) {
  return axios({
      method: 'post',
      baseURL: baseURL_a,
      url,
