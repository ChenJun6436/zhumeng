...
public class AreaController {
	 ...
	 * @return
	 */
	@RequestMapping(value = "/find_ids_by_district",method = RequestMethod.POST)
	@ResponseBody	
	public ResponseVO findIdsByDistrict(@RequestParam(value = "district",required = false)String district){
		ResponseVO vo = new ResponseVO();
		vo.setData(service.findAreaIdsByDistrict(district));
		vo.setCode(ConstantsUtil.RES_SUCCESS_CODE);
		vo.setMessage(ConstantsUtil.RES_SUCCESS_MESSAGE);
		return vo; 
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/find_ids_by_city",method = RequestMethod.POST)
	@ResponseBody	
	public ResponseVO findIdsByCity(@RequestParam(value = "city",required = false)String city){
		ResponseVO vo = new ResponseVO();
		vo.setData(service.findAreaIdsByCity(city));
		vo.setCode(ConstantsUtil.RES_SUCCESS_CODE);
		vo.setMessage(ConstantsUtil.RES_SUCCESS_MESSAGE);
		return vo; 
	}
