	...
	view = {
		...
		makeDOMNodeIcon: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.ICON,
				...
				"'>",name,"</span>");
				if(node.level==0){
					html.push("</span><span class='counts'>(0)</span>")
				}
		},
		...
		makeDOMNodeNameAfter: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.SWITCH,	"' title='' class='", view.makeNodeLineClass(setting, node), "' treeNode", consts.id.SWITCH,"></span><span></span>");
		},
		makeDOMNodeNameBefore: function(html, setting, node) {
			...
			html.push("<span id='", node.tId, consts.id.A, "' class='", consts.className.LEVEL, node.level,"' treeNode", consts.id.A," onclick=\"", (node.click || ''),
