	...
	<div class="login_bg1">
		<div class="login_content1">
			...
			<div class="login-right1">
				...
				<el-form class="forgetPassWordM" :v-model="formLabelAlign" status-icon :rules="rules1" ref="formLabelAlign" :label-position="labelPosition" label-width="100px" :model="formLabelAlign">
