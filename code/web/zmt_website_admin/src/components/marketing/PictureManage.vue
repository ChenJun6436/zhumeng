	...
	<div>
     ...
     <!--新增banner的弹框start-->
	     <el-dialog title="新增" :visible.sync="dialogFormVisible" :show-close = "false">
	     	<img src="../../assets/pic_manage/ic_close.png" alt=""  class="closeBtn" @click ="cloaeDig"/>
...
export default {
  ...
  data(){
      return{
      	  saveMsgUrl:'http://192.168.5.154:8080/zmt-ow/image/save',
      	  orginPic:orginPic,
      	  orginIsShow:true,
//    	  pictureSize:'',
      	  elInput :null,
  ...
  methods:{
  	...
  	getfile(e){
    	...
    	let pictureSize = e.target.files[0].size;
