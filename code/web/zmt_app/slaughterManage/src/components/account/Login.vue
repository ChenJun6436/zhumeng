<template>
	<div class="login-box">
		...
		<div class="login-form">
			<div class="input_box">
				<img class="input_img" :src="i_user_u">
				<input class="input" type="text" placeholder="账号/手机号" v-model="account">
			</div>
			<div class="input_box">
				<img class="input_img" :src="i_password_u">
				<input class="input" type="password" placeholder="·······" style='font-size: .5rem;font-weight: bold' v-model="passWord">
			</div>
			...
			Login() {
				...
				if(!this.account) {
					...
					if(!this.passWord) {
						...
						this.flag = false
						let md5Ps = this.getmd5(this.passWord)
						let LoginData = {
