<template>
	...
	<div class="news_box">
		<ul class="nav">
			<li>屠宰场设置 》 </li>
			<li class="active">猪舍管理 </li>
		</ul>
		<div class="news-content">
			<span @click='addBtn' :plain="true" class="add-btn"><span class="el-icon-plus"> </span> 新建猪舍</span>
			<!-- <div style='float: right;margin-right: 35px;'>
				<el-input style='width: 378px;height: 41px;' placeholder="姓名/联系方式"></el-input>
...
//				this.$router.push({ name: 'NewsEditor',params:{other:1}});
				this.$router.push({ name: 'Pigsty_Add',params:{type:'ad'} });
			},
			//编辑新闻
			handleEdit(index,row) {
//				localStorage.setItem('newsEditorData', JSON.stringify(row));
				this.$router.push({ name: 'Pigsty_Add',params:{type:'ed'} });
			},
			//删除新闻
