<template>
	<div class="news_box">
		...
		<div class="news-content" style="padding-left: 50px;">
			<p style="line-height: 100px;font-size: 18px;font-weight: bold;">基础信息
			...
			<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="110px" class="demo-ruleForm" label-position='right' style='width: 780px;'>
			  ...
			  <el-form-item  v-show='!editor' label="姓名：">
		    	<span>xxxx</span>
			  </el-form-item>
			  ...
			  <el-form-item  v-show='!editor' label="联系方式：">
			    <div>
			    	<span>xxxx</span>
			    	<span style="font-size: 14px;margin-left: 20px;color: #1FB5AD;cursor: pointer;">
						换绑
					</span>
			    </div>
			  </el-form-item>
			  <el-form-item v-show='editor' label="联系地址：" prop="region">
			  ...
			  <el-form-item  v-show='!editor' label="联系地址：">
			    <span>xxxx</span>
			  </el-form-item>
