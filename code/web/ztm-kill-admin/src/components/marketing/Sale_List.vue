		...
		<div class="news-content">
			<div style="overflow: hidden">
				<p style='float:left;margin-left: 40px;margin-top: 30px;font-weight: bold'>
					<span>共销售生猪：xx/头</span>
					<span style='margin-left: 80px;'>共销售订单：xx/笔</span>
				</p>
			...
			<div style="margin-top:20px">
				<span @click='addBtn' :plain="true" style='margin:0;margin-left: 40px;' class="add-btn"><span class="el-icon-plus"> </span> 销售录入</span>
			...
			<el-table :data="tableData" class='tableData' stripe>
				...
				<el-table-column label="销售商">
					<template slot-scope="scope">
						<span class="news-titlt">{{ scope.row.title}}</span>
					</template>
				</el-table-column>
				<el-table-column label="数量/头">
					<template slot-scope="scope">
						<span class="news-titlt">{{ scope.row.title}}</span>
					</template>
				</el-table-column>
				...
				<el-table-column label="操作">
					<template slot-scope="scope">
						<el-button class='editBtn' size="mini" @click="handleEdit(scope.$index, scope.row)">查看详情</el-button>
					</template>
				</el-table-column>
			</el-table>
			<el-pagination
