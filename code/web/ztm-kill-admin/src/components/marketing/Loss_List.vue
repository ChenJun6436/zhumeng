	...
	<div class="news_box">
		...
		<div class="news-content">
			<div style="line-height: 80px">
				<span @click='addBtn' :plain="true" class="add-btn"><span class="el-icon-plus"> </span> 销售录入</span>
