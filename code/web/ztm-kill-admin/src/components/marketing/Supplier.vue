<template>
	...
	<div class="news_box">
		<ul class="nav">
			<li>屠宰场设置 》 </li>
			<li>合作商管理 》 </li>
			<li class="active">合作供应商 </li>
		</ul>
		<div class="news-content">
			<span @click='addBtn' :plain="true" class="add-btn"><span class="el-icon-plus"> </span> 新增供应商</span>
...
//				this.$router.push({ name: 'NewsEditor',params:{other:1}});
				this.$router.push({ name: 'Distributor_Add',params:{type:'ad2'} });
			},
			//编辑新闻
