	...
	<div class="news_box">
		...
		<div class="news-content">
			...
			<div style="margin-top:20px">
				<span @click='addBtn' :plain="true" style='margin:0;margin-left: 40px;' class="add-btn"> 生猪录入</span>
				<div style='float: right;margin-right: 40px;'>
					<span style='font-weight: bold;margin-left: 40px;'>筛选：</span>
					<el-select style='width: 225px' v-model="allFunction" placeholder="全部销售员">
