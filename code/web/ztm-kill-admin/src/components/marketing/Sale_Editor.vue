	...
	<div class="news_box">
		...
		<div class="news-content" style='padding-bottom: 60px;'>
			<div style="line-height: 80px">
				<span style='margin-left: 40px;font-size: 18px;font-weight: bold;color: #1FB5AD'> 销售信息</span>
			</div>
			...
			<div style='margin-left: 40px;margin-top: 40px;overflow: hidden'>
				<div style='width: 50%;float: left;border-right: 1px solid #ddd;'>
					<ul class="codeList">
						<li>
							<span class='nam'>销售单号：</span>
							<span class='val'>xxx</span>
						</li>
						<li>
							<span class='nam'>录入员：</span>
							<span class='val'>xxx</span>
						</li>
						<li>
							<span class='nam'>录入时间：</span>
							<span class='val'>xxx</span>
						</li>
						<li style="margin-top: 40px;">
							<span class='nam'>销售商</span>
							<span class='val'>xxx</span>
						</li>
						<li>
							<span class='nam'>生猪总数：</span>
							<span class='val'>xxx</span>
						</li>
						<li>
							<span class='nam'>总重量</span>
							<span class='val'>xxx</span>
						</li>
						<li>
						...
						<p style='margin-left: 0px;margin-top: 40px;;font-weight: bold'>凭证
						</p>
						<li>
							<span class='nam'>单据号：</span>
							<span class='val'>xxx</span>
						</li>
				...
				<div style="width: 40%;float: left;margin-left: 80px;">
	  				<div style="line-height: 20px">
						<span style='font-size: 17px;font-weight: bold;'> 耳标信息：</span>
					</div>
					<div>
						<div style="margin-top: 30px;margin-bottom: 20px;">
							<span> 宰后报告编号：xxx</span>
						</div>
