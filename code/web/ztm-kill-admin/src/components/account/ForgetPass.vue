...
<div class="login_bg1">
    <div class="login_content1">
        <img class="closeBtn" src="../../assets/login_img/ic_close.png" @click="closePage"  style="cursor:pointer;" alt="">
        ...
        <div class="login-right1">
            ...
            <div>
                <button class="sign_in1"  style="cursor:pointer;" @click="updatePs('formLabelAlign')">确定</button>
            </div>
        </div>
    </div>
